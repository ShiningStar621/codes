...
class WindowPositionManager:
    ...
    def __init__(self):
        ...
        self.positions = [
            ...
            (1440,20),	(1500,20),	(1560,20),(1440,80),	(1500,80),	(1560,80),(1440,140),	(1500,140),	(1560,140),(1440,200),	(1500,200),	(1560,200),
...
def video_crop_with_ocr(
    model_path: str = r"C:\Users\qixin\runs\segment\train47\weights\best.pt",
            ...
            if frame_count % process_interval == 0:
                ...
                for result in results:
                    ...
                    for obj_idx, (box, cls_id) in enumerate(zip(
                        ...
                        target_camera_coords = pixel2camera((x1+x2)/2, (y1+y2)/2 , 18)     #相机高度需给出
                        enu = camera2enu(target_camera_coords,fenu,12,pitch=90, yaw=0, roll=0)#这一行的量都需要飞控提供
                        closest_index = find_closest_point(measured_points, enu)
                        print(f"目标应为已测量的{closest_index}号标靶")"""
                        ...
                        """# 关闭旧窗口（如果位置被复用）
                        if win_name in active_windows:
                            cv2.destroyWindow(win_name)
                            active_windows.remove(win_name)"""
...
if __name__ == "__main__":
    video_crop_with_ocr(
        video_path=r"Z:\对地\数据集（标靶）\2024数据集及处理代码\video_blue(0908)\新标靶9.8.MOV",
        process_interval=1
    )